#ifndef STELLINE_DOMAINS_TRANSPORT_ATA_RECEIVER_MODULE_IMPL_HH
#define STELLINE_DOMAINS_TRANSPORT_ATA_RECEIVER_MODULE_IMPL_HH
...
#endif  // STELLINE_DOMAINS_TRANSPORT_ATA_RECEIVER_MODULE_IMPL_HH
